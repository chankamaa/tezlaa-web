...
const heroSlides = [
  {
    ...
    image: "/images/hero/hero-1.jpg", // Coffee being poured
  ...
  },
  {
    ...
    image: "/images/hero/hero-2.jpg", // Sustainability
  ...
  },
  {
    ...
    image: "/images/hero/hero-3.jpg", // Community
...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-50 to-red-50 pt-8">
      {/* Animated Background */}
      <motion.div
